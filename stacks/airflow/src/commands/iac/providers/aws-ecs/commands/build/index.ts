/** `dude iac build` — build the Airflow production image. */
...
export const iacBuildCommand: StackCommandDef = {
  available: hasIac,
  description:
    'Build the Airflow production image (airflow/Dockerfile.prod — DAGs, plugins and requirements baked in), tagged for the shared ECR.',
