...
/**
 * Auto-discover lint check source files under src/commands/lint/checks/{GROUP}/{id}.ts
 * and emit each as a separate output file so the `dude lint` runner can
 * dynamic-import them individually at runtime.
 *
 * Convention: src/commands/lint/checks/MCP/001.ts → dist/commands/lint/checks/MCP/001.js → code "MCP001"
 */
