...
export default defineCommand({
  description: 'Seed the site with demo tickets.',
  args: {
    count: { type: 'string', description: 'How many tickets to create.', default: '10' },
  },
...
export default defineCommand({
  description: 'Tail the bench logs.',
  async run() {
    await execa('docker', ['compose', 'logs', '-f', 'bench'], { stdio: 'inherit' })
  },
})
```
